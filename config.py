...
SHCXXFLAGS      = CXXFLAGS
TARGET_ARCH     = 'x86_64'
MSVC_VERSION    = '17.0'  # Visual Studio 2022 对应的版本号
...
BOOSTLIB        = ['boost_system-vc142-mt-1_76', 'boost_filesystem-vc142-mt-1_76', 'boost_thread-vc142-mt-1_76']  # 更新到新的boost库版本
...
LIBSUFFIX       = '.lib'
PROGSUFFIX      = '.exe'
PYTHON27LIB     = ['boost_python27-vc142-mt-1_76', 'python27']  # 更新到新的boost库版本
PYTHON27INCLUDE = ['#dependencies/include/python27']
PYTHON35LIB     = ['boost_python35-vc142-mt-1_76', 'python35']  # 更新到新的boost库版本
PYTHON35INCLUDE = ['#dependencies/include/python35']
PYTHON36LIB     = ['boost_python36-vc142-mt-1_76', 'python36']  # 更新到新的boost库版本
